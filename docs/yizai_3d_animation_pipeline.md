...
当前运行资源以 AI 视频效果优先版 pro sheet 为准；历史横向 sheet 仅保留为 legacy fallback。

| 动作 | 帧数 | FPS | 循环 | Sheet 排布 | Sheet 尺寸 |
| --- | ---: | ---: | --- | --- | --- |
| idle | 12 | 12 | 是 | 6x2 | 3072x1024 |
| attack | 16 | 20 | 否 | 8x2 | 4096x1024 |
| skill | 24 | 20 | 否 | 8x3 | 4096x1536 |
| ultimate | 32 | 24 | 否 | 8x4 | 4096x2048 |
| hurt | 12 | 20 | 否 | 6x2 | 3072x1024 |
